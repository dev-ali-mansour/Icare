package eg.edu.cu.csds.icare.feature.admin.screen.pharmacy.update
...
@Composable
internal fun UpdatePharmacyScreen(
    ...
    Scaffold(
        topBar = {
            CommonTopAppBar(title = stringResource(id = R.string.feature_admin_update_pharmacy)) {
