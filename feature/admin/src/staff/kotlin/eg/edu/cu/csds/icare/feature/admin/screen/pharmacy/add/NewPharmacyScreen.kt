package eg.edu.cu.csds.icare.feature.admin.screen.pharmacy.add
...
import eg.edu.cu.csds.icare.feature.admin.screen.pharmacy.PharmacyDetailsContent
...
internal fun NewPharmacyScreen(
    ...
    val viewModel: NewPharmacyViewModel = koinViewModel()
    ...
    LaunchedUiEffectHandler(
        viewModel.effect,
        onConsumeEffect = { viewModel.handleIntent(PharmacyIntent.ConsumeEffect) },
        onEffect = { effect ->
            when (effect) {
    ...
    Scaffold(
        topBar = {
            CommonTopAppBar(title = stringResource(id = R.string.feature_admin_new_pharmacy)) {
