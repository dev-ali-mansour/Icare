package eg.edu.cu.csds.icare.feature.admin.screen.doctor.add
...
internal fun NewDoctorScreen(
    ...
    val viewModel: NewDoctorViewModel = koinViewModel()
    ...
    Scaffold(
        topBar = {
            CommonTopAppBar(title = stringResource(id = R.string.feature_admin_new_doctor)) {
